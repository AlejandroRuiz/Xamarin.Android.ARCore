...
namespace Xamarin.Android.ARCore.Test.Rendering
{
    ...
    {
        private const string TAG = nameof(BackgroundRenderer);
		...
		public void Draw(Frame frame)
		{
			...
			GLES20.GlVertexAttribPointer(mQuadTexCoordParam, TEXCOORDS_PER_VERTEX, GLES20.GlFloat, false, 0, mQuadTexCoordTransformed);
        ...
        public static float[] QUAD_COORDS = new float[]{
            -1.0f, -1.0f, 0.0f,
            -1.0f, +1.0f, 0.0f,
            +1.0f, -1.0f, 0.0f,
            +1.0f, +1.0f, 0.0f,
