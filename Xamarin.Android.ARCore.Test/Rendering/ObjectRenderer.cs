...
namespace Xamarin.Android.ARCore.Test.Rendering
{
    ...
    {
        private const string TAG = nameof(ObjectRenderer);
        ...
        private static float[] LIGHT_DIRECTION = new float[] { 0.0f, 1.0f, 0.0f, 0.0f };
        ...
        private BlendMode mBlendMode = BlendMode.None;
        ...
        public void CreateOnGlThread(Context context, string objAssetName, string diffuseTextureAssetName)
        {
            ...
            {
                // Read the texture.
                Bitmap textureBitmap = BitmapFactory.DecodeStream(context.Assets.Open(diffuseTextureAssetName));
                ...
                global::Android.Opengl.Matrix.SetIdentityM(mModelMatrix, 0);
            }
            catch
            {
        ...
        public void UpdateModelMatrix(float[] modelMatrix, float scaleFactor)
        {
            ...
            global::Android.Opengl.Matrix.SetIdentityM(scaleMatrix, 0);
            scaleMatrix[0] = scaleFactor;
            scaleMatrix[5] = scaleFactor;
            scaleMatrix[10] = scaleFactor;
            global::Android.Opengl.Matrix.MultiplyMM(mModelMatrix, 0, modelMatrix, 0, scaleMatrix, 0);
        }
        ...
        public void Draw(float[] cameraView, float[] cameraPerspective, float lightIntensity)
        {
            ...
            global::Android.Opengl.Matrix.MultiplyMM(mViewLightDirection, 0, mModelViewMatrix, 0, LIGHT_DIRECTION, 0);
